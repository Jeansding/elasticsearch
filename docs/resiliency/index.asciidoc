...
{GIT}?q=label%3Aresiliency[resiliency].
...
If you encounter an issue, {GIT}[please report it]!
...
A master node in Elasticsearch continuously {ref}/cluster-fault-detection.html[monitors the cluster nodes]
